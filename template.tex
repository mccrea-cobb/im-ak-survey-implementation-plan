...
\begin{center}\huge Refuge Inventory and Monitoring, Alaska\end{center}
\begin{center}\includegraphics[width=4cm]{images/fws_logo.png}\end{center}
\vskip 0.5em}
...
$if(pdf-title)$
\title{\Huge $for(pdf-title)$$pdf-title$$endfor$}
$endif$
